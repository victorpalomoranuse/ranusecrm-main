...
function TabAsignaciones({ projectId, categoryId, listadosIntro, listadosTitle, onIntroUpdated }) {
  ...
  const isAssigned=(productId,type)=>{const list=visibleAssigned(type==='material'?assigned.materials:assigned.equipment);return list.some(a=>a.catalog_product_id===productId);};
